...
<ul id="lnb">
	<li class="lnb_faq depth1 on">
		...
		<ul style='display:block;'">
			...
			<li><a href="faqlistAction.action?type=type1" class="">주문/배송</a></li>

			<li><a href="faqlistAction.action?type=type2" class="">제품문의</a></li>

			<li><a href="faqlistAction.action?type=type3" class="">반품/교환</a></li>

			<li><a href="faqlistAction.action?type=type4" class="">사이트이용관련</a></li>

			<li><a href="faqlistAction.action?type=type5" class="">쿠폰</a></li>

			<li><a href="faqlistAction.action?type=type6" class="">오프라인매장,기타</a></li>
		...
		<!-- con_wrap -->
				<div class="con_wrap">	
					...
					<div class="customer_view">
						...
						<div class="view_box">
							<div style="line-height: 90%; margin-top: 10pt; margin-bottom: 0pt; margin-left: 0.25in; text-indent: -0.25in; direction: ltr; unicode-bidi: embed;">
					...
					<div class="view_top_box bottom">
							...
							<a href="faqlistAction.action?type=<s:property value = "type"/>" class="btn_back">BACK TO LIST</a>
