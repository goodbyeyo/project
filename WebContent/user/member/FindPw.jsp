...
<body>
	<form name="hi" action="findPwAction.action" method="post" onsubmit=return check()">
				...
				<td align="center" style="padding-top: 50px; padding-bottom: 50px;">
					...
					<table width="600" height="250" border="0" class="findform">
							...
							<td align="center" style="padding-bottom: 20px;">
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td height="35">
										<input type="text" name="member_id" size="17" style="width: 230px; height: 26px; border: 1px solid rgb(204,204,204);"></td>
									</tr>
						...
						<tr>
							...
							<input type="submit" value="비밀번호 찾기" class="submit"></td>
						</tr>
