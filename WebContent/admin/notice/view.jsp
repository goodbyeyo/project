			...
			<div class="mypage_wrap">
				<div class="lnb_wrap">
					...
					<h2 class="title_style">
						<a href=adminnoticelist.action">공지사항게시판</a>
					</h2>
					<ul>
				...
				<div class="con_wrap">
					...
					<div class="customer_view">
						<h2 class="tit">
							<s:property value="resultClass.notice_sub" />
						</h2>
						<div class="view_box">
							<div>
					...
					<div class="view_top_box bottom">
						<td align="right" colspan="2">
							...
							onClick="javascript:location.href='adminnoticemodifyform.action?notice_no=<s:property value="resultClass.notice_no" />&currentPage=<s:property value="currentPage" />'">

							<input name="list" type="button" value="삭제" class="hreflink"
							onClick="javascript:location.href='adminnoticedelete.action?notice_no=<s:property value="resultClass.notice_no" />&currentPage=<s:property value="currentPage" />','delete'">
					</div>
					<!-- //view_sns_box -->
				</div>
			</div>
