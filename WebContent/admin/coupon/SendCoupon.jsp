	...
	<!-- start of :: contents -->
		<div id="contents">
			<div class="customer_wrap">
						...
						<table>
							...
							<thead>
								<tr>
									...
									<th width = "10%"><strong>회원 선택</strong></th>
								</tr>
							</thead>
							<tbody>
							...
							<tr>
								...
								<td><input class = "hreflink" type="button" value="선택" onClick="javascript:location.href='CouponSendAction.action?currentPage=<s:property value="currentPage"/>&coupon_no=<s:property value="coupon_no"/>&member_no=<s:property value="member_no"/>'"/></td>
							</tr>
							</s:iterator>
				...
				<s:textfield name="searchk" theme="simple" value="" cssStyle="width:120px" maxlength="20" />
