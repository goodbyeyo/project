		...
		<div id="contents">
			<div class="customer_wrap">
					...
					<div class="customer_view">
						<h2 class="tit"><s:property value="resultClass.msg_sub"/></h2>
						<div class="view_box">
					...
					<div class="view_top_box bottom">
							...
							<a href="msgdeleteAction.action?msgboxtype=<s:property value = "msgboxtype"/>&msg_no=<s:property value = "msg_no"/>&currentPage=<s:property value ="currentPage"/>" class="btn_back">삭제</a>
							<a href="msgbox.action?msgboxtype=<s:property value = "msgboxtype"/>" class="btn_back">BACK TO LIST</a>
