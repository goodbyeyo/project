...
public class viewAction extends ActionSupport{
	...
	private QnAVO replyClass = new QnAVO();
	...
	public String execute() throws Exception{
		...
		replyClass = (QnAVO) sqlMapper.queryForObject("selectreplyQnA",getQna_no());
	...
	public QnAVO getReplyClass() {
		return replyClass;
	}

	public void setReplyClass(QnAVO replyClass) {
