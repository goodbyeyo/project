...
public class PagingAction {
	...
	public PagingAction(int currentPage, int totalCount, int blockCount, int blockPage, int searchNum,
		...
		if (currentPage > blockPage) {
			if (isSearch != "")
				pagingHtml.append("<a href=adminmemberlist.action?currentPage=" + (startPage - 1) + "&searchKeyword=" + isSearch
						+ "&searchNum=" + searchNum + ">");
			else
				pagingHtml.append("<a href=adminmemberlist.action?currentPage=" + (startPage - 1) + ">");
