...
public class pagingAction {
	...
	public pagingAction(int currentPage, int totalCount, int blockCount, int blockPage, String searcht,
		...
		if (currentPage > blockPage) {
			if (searchk != "")
				pagingHtml.append("<a href=adminnoticelist.action?currentPage=" + (startPage - 1) + "&searchk="
						+ searchk + "&searcht=" + searcht + ">");
			else
				pagingHtml.append("<a href=adminnoticelist.action?currentPage=" + (startPage - 1) + ">");
